...
my %Critical = (
    ...
    NO2    => { Tc => 431.4,   Pc => 10100.0, omega => 0.85,   note => "NO2 may dimerize; EOS estimate" },
    ...
    NH3    => { Tc => 405.4,   Pc => 11333.0, omega => 0.256,  note => "ammonia; associating gas estimate" },
    AR     => { Tc => 150.687, Pc => 4863.0,  omega => -0.002, note => "argon" },
